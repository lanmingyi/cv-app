<template>
	<view class="v587-color-picker" @touchmove.stop.prevent @click.stop>
		<view id="slider" ref="slider" class="sv-picker" @touchstart="setSlider($event, 'sv')"
			...
			<!-- background: 'linear-gradient(to right, #ffffff, #ffffff00)' 移动端只识别6位颜色值-->
			<view class="sv-picker-background" :style="{backgroundColor: svBackgroundColor}"></view>
			<view class="sv-picker-background" :style="{background: 'linear-gradient(to right, #ffffff, transparent)'}">
			</view>
			<view class="sv-picker-background" :style="{background: 'linear-gradient(to top, #000000, transparent)'}">
			</view>
...
<style lang="scss" scoped>
	...
	.v587-color-picker {
		...
		.sv-picker {
			...
			.sv-picker-background-right{
				/* Firefox 3.6+ */
				background: -moz-linear-gradient(right, #ffffff, #ffffff00);
				/* Safari 4-5, Chrome 1-9 */
				background: -webkit-gradient(linear,right,from(#ffffff),to(#ffffff00));
				/* Safari 5.1+, Chrome 10+ */
				background: -webkit-linear-gradient(right, #ffffff, #ffffff00);
				/* Opera 11.10+ */
				background: -o-linear-gradient(right, #ffffff, #ffffff00);
			}
			.sv-picker-background-top{
				/* Firefox 3.6+ */
				background: -moz-linear-gradient(top, #000000, #ffffff00);
				/* Safari 4-5, Chrome 1-9 */
				background: -webkit-gradient(linear,top,from(#000000),to(#ffffff00));
				/* Safari 5.1+, Chrome 10+ */
				background: -webkit-linear-gradient(top, #000000, #ffffff00);
				/* Opera 11.10+ */
				background: -o-linear-gradient(top, #000000, #ffffff00);
			}
		}
