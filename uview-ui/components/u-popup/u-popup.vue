<template>
	<view v-if="visibleSync" :style="[customStyle, {
		...
		<view class="u-drawer-content" @tap="modeCenterClose(mode)" :class="[
			...
			]" :style="[style]" @tap.stop.prevent>
			<!-- @touchmove.stop.prevent -->
			<view class="u-mode-center-box" @tap.stop.prevent v-if="mode == 'center'" :style="[centerStyle]">
			...
			<view @tap="sure" class="u-sure" :class="['u-sure--' + sureIconPos]">
				<u-icon v-if="mode != 'center' && sureable" :name="sureIcon" :color="sureIconColor"
					:size="sureIconSize"></u-icon>
			</view>
		</view>
	</view>
</template>
...
<script>
	...
	export default {
		...
		props: {
			...
			// 确认图标的名称，只能uView的内置图标
			sureIcon: {
				type: String,
				default: 'checkmark'
			},
			// 自定义确认图标位置，top-left为左上角，top-right为右上角，bottom-left为左下角，bottom-right为右下角
			sureIconPos: {
				type: String,
				default: 'top-right'
			},
