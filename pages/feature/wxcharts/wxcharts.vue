	...
	*/
	...
	export default {
		...
		methods: {
			getServerData(){
				uni.request({
					url: 'http://mock.zuoyour.com/mock/5e14747df250262247c1dda6/app/getChartData',
					data:{
					},
					success: function(res) {
...
/* 横屏样式 */
.qiun-charts-rotate{width: 100%; height:1200upx;background-color: #FFFFFF;padding: 25upx;}
.charts-rotate{width: 700upx; height:1000upx;background-color: #FFFFFF;}
/* 圆弧进度样式 */
...
.qiun-tip {display:block; width:92vw; overflow:hidden; padding:15upx; height:60upx; line-height:30upx; margin:10upx; background:#ff9933; font-size:30upx; border-radius:8upx;justify-content:center; text-align:center;border: 1px solid #dc7004;color: #FFFFFF;}
</style>
