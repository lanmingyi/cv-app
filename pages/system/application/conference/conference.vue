				...
				<view class="cu-item" :class="modalName=='move-box-'+ index?'move-cur':''" v-for="(item,index) in vacate" :key="index"
				 @touchstart="ListTouchStart" @touchmove="ListTouchMove" @touchend="ListTouchEnd" :data-target="'move-box-' + index">
					...
					<view class="action">
						...
						<view class="text-orange sm">{{item.type}}</view>
					</view>
					<view class="move">
...
<script>
	...
	export default {
		data() {
			return {
				...
				vacate : [
					...
					{ img: '@/static/img/per_01.jpg', name: "项目", desc: '周例会', time: "2019-03-01 ~ 2019-03-01", type: "审批中"},
					{ img: '@/static/img/per_01.jpg', name: "项目", desc: '周例会', time: "2019-03-01 ~ 2019-03-01", type: "审批中"},
					{ img: '@/static/img/per_01.jpg', name: "项目", desc: '周例会', time: "2019-03-01 ~ 2019-03-01", type: "审批中"}
				],
				vacate2 : [
					//img - 图片地址 title - 标题 desc - 描述 - status 读取状态
					{ img: '@/static/img/per_01.jpg', name: "项目", desc: '周例会', time: "2019-03-01 ~ 2019-03-01", type: "已审批"},
					{ img: '@/static/img/per_01.jpg', name: "项目", desc: '周例会', time: "2019-03-01 ~ 2019-03-01", type: "已审批"},
					{ img: '@/static/img/per_01.jpg', name: "项目", desc: '周例会', time: "2019-03-01 ~ 2019-03-01", type: "已审批"}
				],
				directionStr: '垂直',
		...
		methods:{
			...
			edit :function () {
				uni.navigateTo({
					url:"conference_edit/conference_edit"
				})
			},
			trigger(e) {
				console.log(e);
				...
				if(num==0){
					uni.navigateTo({
						url:'conference_add/conference_add'
					})
				}
				else if(num==1){
...
.grace-scroll-do .grace-items{
	...
	height: 200upx;
	align-items: center;
/* 	background: url(@/static/img/tent_bg.jpg) no-repeat; */
