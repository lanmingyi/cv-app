			...
			<view class="cu-list menu-avatar">
				...
				<view class="cu-item ">
					...
					<view class="content">
						...
						<view class="text-gray   flex"> <view class="text-cut">凯尔，你被自己的光芒变的盲目！</view></view>
					</view>
					<view class="action">
						<view class="text-grey text-xs">22:20</view>
				...
				<view class="cu-item grayscale">
					...
					<view class="content">
						...
						<view class="text-gray   flex"> <view class="text-cut"> 等我回来一个打十个</view></view>
					</view>
					<view class="action">
						<view class="text-grey text-xs">22:20</view>
						<view class="cu-tag round bg-red sm">5</view>
