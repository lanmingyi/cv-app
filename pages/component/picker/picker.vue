<template>
	<view id="page">
		...
		<view class="cu-bar bg-box solid-bottom margin-top">
			<view class="action">
				<text class="cuIcon-title text-orange "></text> 普通选择器
			</view>
		</view>
		...
		<view class="cu-bar bg-box solid-bottom margin-top">
			<view class="action">
				<text class="cuIcon-title text-orange "></text> 多列选择器
			</view>
		</view>
		<view class="cu-form-group">
			<view class="title">当前选择</view>
		...
		<view class="cu-bar bg-box solid-bottom margin-top">
			<view class="action">
				<text class="cuIcon-title text-orange "></text> 时间选择器
			</view>
		</view>
		<view class="cu-form-group">
			<view class="title">当前选择</view>
		...
		<view class="cu-bar bg-box solid-bottom margin-top">
			<view class="action">
				<text class="cuIcon-title text-orange "></text> 日期选择器
			</view>
		</view>
		<view class="cu-form-group">
			<view class="title">当前选择</view>
