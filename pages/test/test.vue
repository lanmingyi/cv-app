	...
	<view>
		...
		<view class="category-list">
			...
			<scroll-view  scroll-y="true" class="left" >
                <view class="row" v-for="(category,index) in rows" :key="category.creatorOrgId" :class="[index==showCategoryIndex?'on':'']" @tap="showCategory(index)">
					<view class="text">
			...
			<scroll-view  scroll-y="true" class="right" >
			    <view class="category" v-for="(category,index) in rows" :key="category.creatorOrgId" v-show="index==showCategoryIndex" >
					<view class="banner">
						
					</view>
					<view class="list">
						<view class="box"  v-for="(box,i) in rows" :key="i" @tap="toCategory(box)">
							<view class="text">{{box.userName}}</view>
						</view>
					</view>
				</view>
			</scroll-view>
