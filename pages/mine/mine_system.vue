<template>
	<view class="container" :class="[vtheme]">
		<scroll-view scroll-y class="DrawerPage" :class="modalName=='viewModal'?'show':''">
			<!-- bg-theme -->
			<view class="user-info pos-relative flex align-center justify-center">
				<view @click="goToPage('mine_details/mine_details')" class="flex align-center justify-center ">
			...
			<view class="flex align-center justify-between padding-tb-sm bg-box" >
			...
			<view class="margin-lr">
				<view class="shadow-warp radius bg-box  margin-top">
					...
					<view class="margin-lr padding-top-sm padding-bottom-sm border-bottom flex align-center transition-box animation-slide-bottom"
						@click="goToPage('favorite/favorite')" style="animation-delay: 0.3s;">
						<u-icon size="38" name="heart-fill" class="margin-right" style="color: #DF6856"></u-icon>
						<text class="font-main ">我的收藏</text>
					</view>
				</view>
