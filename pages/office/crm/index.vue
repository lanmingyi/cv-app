		...
		data() {
			return {
				...
				cuIconList:[{
					...
					name: '同IP客户',
					cuIcon: 'agriculture',
					url: './sort/collapseList?state=sameAsIP&title=同IP客户'
				},{
					name: '同公司客户',
					cuIcon: 'shouhuoicon',
					url: './sort/collapseList?state=sameAsCompany&title=同公司客户'
				},{
					name: '同地区客户',
					cuIcon: 'goumaipianhao',
					url: './sort/collapseList?state=sameRregion&title=同地区客户'
				},{
					name: '多次访问',
					cuIcon: 'ascending',
