	...
	<view class="container" :class="[vtheme]">
		<u-form :model="journalData" :rules="rules" ref="uForm" :errorType="errorType" class="u-padding-bottom-80 u-margin-bottom-50 bg-box">
			<view class="padding-lr">
				<u-form-item label-width="180" label-position="top" label="本月工作内容" prop="logContent" :required="true">
				...
				<u-form-item label-width="180" label-position="top" label="本月工作总结" >
					<u-input :border="false" v-model="journalData.logSummary" type="textarea"  placeholder="请输入"></u-input>
				</u-form-item>
		...
		<view class="bottom-btn-appro u-margin-top-80 flex align-center justify-center">
			<view class="cu-botton-submit text-center" @click="formSubmit">提交月报</view>
		</view>
