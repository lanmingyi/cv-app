		...
		<view v-if="emptyType===2">
			...
			<view class="padding-lr bg-box">
				<u-form :model="reserveData" ref="uForm">
					...
					<u-form-item label-width="180" label-position="top" label="会议时间" >
						<u-form-item label-width="0" label-position="left" label="" class="border-bottom-none" style="padding: 0;">
							<u-input :border="false" v-model="reserveData.reserveStartDate" type="text" disabled></u-input>
						</u-form-item>
						<view class="border-center"></view>
						<u-form-item label-width="50" label-position="left" label=" " class="border-bottom-none" style="padding: 0;">
							<u-input :border="false" v-model="reserveData.reserveEndDate" type="text" disabled></u-input>
						</u-form-item>
					</u-form-item>
					
					<!-- <u-form-item label-width="180" label-position="left" label="开始时间：" >
						<u-input :border="false" v-model="reserveData.reserveStartDate" type="text" disabled></u-input>
					</u-form-item>
					<u-form-item label-width="180" label-position="left" label="结束时间：" >
						<u-input :border="false" v-model="reserveData.reserveEndDate" type="text" disabled></u-input>
					</u-form-item> -->
					<u-form-item label-width="180" label-position="top" label="会议室地点" >
						<u-input :border="false" v-model="reserveData.address" type="text" disabled></u-input>
					</u-form-item>
				</u-form>
			</view>
		</view>
