			...
			<swiper class="swiper-box" :current="swiperCurrent" :show-bar="false">
				<swiper-item class="swiper-item tab-content" @touchmove.stop=""  ref="print">
					<scroll-view scroll-y style="height: 100%;width: 100%;">
						<view class="padding-top no-print">
						...
						<view class="text-box-line no-print"></view>
						<movable-area class="swiper-box pos-relative" id="printTest">
							<view>
	...
	export default {
		data() {
			return {
				...
				sureShow: false,
				showSeal: false,
				sealImgUrl: 'https://zysd-emis.oss-cn-shanghai.aliyuncs.com/user/avatar/ewsd0001/c03e022dc1dd4688b37ef0995a541985.png'
			};
		},
		onLoad() {
