<template>
	<view class="container" :class="[vtheme]">
		...
		<view class="bg-box padding-bottom-xs" v-if="emptyType===2">
			<view class="banner padding" id="container-title">
				<view class="banner-title text-bold text-main-title u-font-32">{{data.newsTitle}}</view>
			</view>
			<view class="article-meta padding-lr padding-bottom-sm flex align-center justify-between border-bottom">
				<view class="font-three">
					<u-icon custom-prefix="custom-icon" class="icon-color-main margin-right-sm" name="user1"></u-icon><text class="article-author">{{data.publisher}}</text>
				</view>
				<view class="font-three">
					<u-icon custom-prefix="custom-icon" class="icon-color-main margin-right-sm" name="shijian1"></u-icon><text class="article-time">{{data.releaseTime}}</text>
				</view>
			</view>
			...
			<view class="cu-bar bg-box border-bottom">
				<view class="action">
					<u-icon class="icon-text-color margin-right-sm" name="attach"></u-icon>
