	...
	<view id="fl_signin">
					...
					<template v-if="is_today_date">
						<template v-if="index<day_index">
							...
							<template v-else-if="repair">
								<view class="day repair" @click="repair_fun(item,index)">
									<text>{{item.day}}</text>
									<text>补签{{item.index}}</text>
								</view>
							</template>
							<template v-else>
						...
						<template v-else-if="index==day_index">
							...
							<template v-else>
								<view class="day today" @click="signin_fun(item)">
									<text>{{item.day}}</text>
									<text>未签</text>
								</view>
							</template>
		...
		<view class="footer">
			...
			<view class="signin" v-if="is_today_date">
				...
				<view class="btn true" @click="signin_fun(days[day_index])" v-else>
					<text>签到</text>
				</view>
			</view>
		</view>
