	...
	<view>
		<view class="fab-box fab" :class="{
			...
			<view class="fab-circle" :class="{
				...
				<text class="cuIcon-add text-white font-size-max" :class="{ active: showContent }"></text>
			</view>
			<!-- &#xe639; -->
			<!-- uni-icon uni-icon-plusempty -->
			<view class="fab-content flex align-center" :class="{
				...
				<view class="fab-item " v-for="(item, index) in content" :key="index" :class="{ active: showContent }"
					:style="{
						color: item.active ? styles.selectedColor : styles.color
					}" @click="taps(index, item)">
					<!-- <image class="content-image" :src="item.active ? item.selectedIconPath : item.iconPath"
						mode="widthFix"></image> -->
					<text :class="item.selectedIconPath"></text>
...
<style scoped>
	...
	@font-face {
		...
		/* project id 1042951 */
		src: url('https://at.alicdn.com/t/font_1042951_v2kla2ezqes.eot');
		src: url('https://at.alicdn.com/t/font_1042951_v2kla2ezqes.eot?#iefix') format('embedded-opentype'),
			url('https://at.alicdn.com/t/font_1042951_v2kla2ezqes.woff2') format('woff2'),
			url('https://at.alicdn.com/t/font_1042951_v2kla2ezqes.woff') format('woff'),
			url('https://at.alicdn.com/t/font_1042951_v2kla2ezqes.ttf') format('truetype'),
			url('https://at.alicdn.com/t/font_1042951_v2kla2ezqes.svg#iconfont') format('svg');
	}
