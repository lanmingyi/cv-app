	...
	>
		...
		<view class="u-input__right-icon u-flex">
			...
			<view class="u-input__right-icon__clear u-input__right-icon__item" v-if="passwordIcon && type == 'password'">
				<u-icon size="28" :name="!showPassword ? 'eye' : 'eye-fill'" color="#c0c4cc" @click="showPassword = !showPassword"/>
			</view>
			<view class="u-input__right-icon--select u-input__right-icon__item" v-if="type == 'select'" :class="{
				'u-input__right-icon--select--reverse': selectOpen
			}">
				<u-icon :class="iconNameColor" :name="iconName" size="28"></u-icon>
			</view>
		</view>
	</view>
</template>
...
export default {
	...
	props: {
		...
		placeholderStyle: {
			type: String,
			default: 'color: #c0c4cc;font-size: 13px'
		},
		confirmType: {
			type: String,
			default: 'done'
